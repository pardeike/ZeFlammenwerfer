...
namespace BansheeGz.BGSpline.Components
{
	...
	public class BGCcSplitterPolyline : BGCcWithMath
	{
		...
		//===============================================================================================
		[SerializeField]
		[Tooltip("How to split the curve. " +
										  ...
										  "Note, you can tweak some params at Math as well.")]
		private SplitModeEnum splitMode = SplitModeEnum.UseMathData;

		[SerializeField]
		[Range(1, 1000)]
		[Tooltip("Total number of parts to split a curve to. " +
																 "The actual number of parts can be less than partsTotal due to optimization, but never more.")]
		private int partsTotal = 30;


		[SerializeField]
		[Range(1, 150)]
		[Tooltip("Every section of the curve will be split on even parts. " +
																"The actual number of parts can be less than partsPerSection due to optimization, but never more.")]
		...
		[SerializeField]
		[Tooltip("By default positions in world coordinates. Set this parameter to true to use local coordinates. " +
										  "Local coordinates are calculated slower.")]
		...
		protected readonly List<PolylinePoint> points = new();
		...
		{
			dataValid = false;
			ChangedPositions?.Invoke(this, null);
		}
