...
#pragma warning restore 0414
		...
		protected bool ParamChanged<T>(ref T oldValue, T newValue)
		{
			...
			if (oldValueNull && newValueNull)
				return false;

			if (oldValueNull == newValueNull && oldValue.Equals(newValue))
				return false;
		...
		{
			if (ChangedParams != null && transactionLevel == 0)
				ChangedParams(this, null);
		}
		...
		public void Transaction(Action action)
		{
			...
			finally
			{
				...
				{
					ChangedParams?.Invoke(this, null);
				}
			}
		}
