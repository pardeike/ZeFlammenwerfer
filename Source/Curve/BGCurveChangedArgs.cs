...
namespace BansheeGz.BGSpline.Curve
{
	...
	public class BGCurveChangedArgs : EventArgs, ICloneable
	{
		...
		private static readonly BGCurveChangedArgs Instance = new();
		...
		*/
		...
		/// <summary>Init and get event instance</summary>
		public static BGCurveChangedArgs GetInstance(BGCurve curve, BGCurveChangedArgs[] changes, string _)
		{
			Instance.curve = curve;
		...
		/// <summary>Init and get event instance</summary>
		public static BGCurveChangedArgs GetInstance(BGCurve curve, IBGCurvePointI point, string _)
		{
			Instance.curve = curve;
		...
		{
			public static readonly BeforeChange BeforeChangeInstance = new();
