...
namespace BansheeGz.BGSpline.Curve
{
	...
	public class BGCurveReferenceToPoint : MonoBehaviour
	{
		...
		public IBGCurvePointI Point
		{
			get { return pointGo != null ? (IBGCurvePointI)pointGo : pointComponent; }
			set
			{
				if (value == null)
				{
				...
				{
					if (value is BGCurvePointGO gO)
					{
						pointGo = gO;
						pointComponent = null;
					}
					else if (value is BGCurvePointComponent component)
					{
		...
		public static BGCurveReferenceToPoint GetReferenceToPoint(IBGCurvePointI point)
		{
